...
| Semana | Período | Atividade | Métricas | Responsável |
| :---: | :---: | :--- | :---: | :--- |
...
| **Semana 1** | Período 1 | Levantamento do backlog e criação do checklist detalhado de funcionalidades do sistema. | **M1** | [João Pedro](https://github.com/Jadequilin) |
| **Semana 2** | Período 2 | Execução da inspeção funcional (**M1**, **M3**) e execução das baterias de testes automatizados e manuais (**M2**). | **M1, M2, M3** | [João Pedro](https://github.com/Jadequilin) |
| **Semana 2** | Período 2 | Execução de cobertura de testes (**M4**); bateria de testes de disponibilidade (**M5**); testes de tolerância a falhas (**M6**). | **M4, M5, M6** | [Eduardo](https://github.com/eduard0803) |
...
| :--- | :---: | :--- |
| **Ambiente Configurado** | Final da Semana 1 | Ecossistema Docker totalmente operacional, ferramentas analíticas instaladas e deploy externo na Vercel validado. |
